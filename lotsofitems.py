...
category1 = Category(name="Soccer", image="/static/soccer.jpg")

session.add(category1)
session.commit()

item1 = Item(name="Soccer Cleats", description=" Soccer cleats\
...
item2 = Item(name="Shin Guards", description="Soccer is \
...
item3 = Item(name="Socks", description="Soccer socks are extremely \
...
category1 = Category(name="Basketball", image="/static/basketball.jpg")

session.add(category1)
session.commit()


item1 = Item(name="Basketball Sneakers", description="One needs \
...
item2 = Item(name="Athletic Socks", description=" Players should \
                     ...
                     price="$25", category=category1)

session.add(item2)
session.commit()

item3 = Item(name="Elbow Pads", description="There is a lot of \
                     ...
                     price="15", category=category1)

session.add(item3)
session.commit()

item4 = Item(name="Knee Pads", description="Players should wear \
                     knee pads to protect themselves during falls \
                     or dives to the floor. ",
                     price="12", category=category1)

session.add(item4)
session.commit()

# Items used in playing Baseball
category1 = Category(name="Baseball", image="/static/baseball.jpg")

session.add(category1)
session.commit()


item1 = Item(name="Baseball Glove", description="One of the \
...
item2 = Item(name="Baseball Bat", description="There are many \
...
item3 = Item(name="Batting Helmet", description="If you're going \
...
category1 = Category(name="Frisbee", image="/static/frisbee.jpg")

session.add(category1)
session.commit()

# Items used in playing Snowboarding
category1 = Category(name="Snowboarding", image="/static/snowboarding.jpg")

session.add(category1)
session.commit()

# Items used in playing Foosball
category1 = Category(name="Foosball", image="/static/foosball.jpg")

session.add(category1)
session.commit()

# Items used in playing Skating
category1 = Category(name="Skating", image="/static/skating.jpg")

session.add(category1)
session.commit()

# Items used in playing Hockey
category1 = Category(name="Hockey", image="/static/hockey.jpg")

session.add(category1)
session.commit()

# Items used in playing Rock Climbing
category1 = Category(name="Rock Climbing", image="/static/rockclimbing.jpeg")

session.add(category1)
session.commit()

# Items used in playing Rock Climbing
category1 = Category(name="Badminton", image="/static/badminton.jpeg")

session.add(category1)
session.commit()

# Items used in playing Rock Climbing
category1 = Category(name="Cricket", image="/static/cricket.jpg")
